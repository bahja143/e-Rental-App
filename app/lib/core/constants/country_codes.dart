/// All country dial codes with country names - for phone input picker
const List<({String code, String name})> kCountryCodes = [
  ...
  (code: '+441624', name: 'Isle of Man'),
  (code: '+972', name: 'Israel'),
  (code: '+39', name: 'Italy'),
  (code: '+225', name: 'Ivory Coast'),
  (code: '+1876', name: 'Jamaica'),
  (code: '+81', name: 'Japan'),
  (code: '+441534', name: 'Jersey'),
